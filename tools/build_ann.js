...
const doc = new Document({
  ...
  title: 'CPD Public AI Innovation Challenge: Public Announcement (Draft)',
  description: 'Draft public announcement for Procurement review',
  numbering: {
    config: [
  ...
  sections: [{
    ...
    headers: {
      default: new Header({ children: [new Paragraph({
        ...
        spacing: { after: 120 },
        border: { bottom: { style: BorderStyle.SINGLE, size: 4, color: 'C9D2E0', space: 4 } },
        children: [new TextRun({ text: 'CPD Public AI Innovation Challenge  |  Draft for Procurement Review', size: SZ, color: '7A7A7A', font: FONT })],
      })] }),
    },
    footers: {
