...
const doc = new Document({
  ...
  title: 'HUD Section 208 Data and Performance Measurement Requirements Analysis',
  description: 'Analysis of Section 208 data requirements and required changes to the CPD challenge',
  numbering: {
    config: [
  ...
  sections: [{
    ...
    headers: {
      default: new Header({ children: [new Paragraph({
        ...
        spacing: { after: 120 },
        border: { bottom: { style: BorderStyle.SINGLE, size: 4, color: 'C9D2E0', space: 4 } },
        children: [new TextRun({ text: 'HUD Section 208 Data Requirements  |  For CPD, ACM, Grants, Data KC', size: SZ, color: '7A7A7A', font: FONT })],
      })] }),
    },
    footers: {
