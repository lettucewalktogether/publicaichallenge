...
const doc = new Document({
  ...
  title: 'Permit Record Linkage: Minimum Tracking Specification',
  description: 'Minimum identifiers the CPD challenge must carry to join review performance to permit outcomes',
  numbering: {
    config: [
  ...
  sections: [{
    ...
    headers: {
      default: new Header({ children: [new Paragraph({
        ...
        spacing: { after: 120 },
        border: { bottom: { style: BorderStyle.SINGLE, size: 4, color: 'C9D2E0', space: 4 } },
        children: [new TextRun({ text: 'Permit Record Linkage Specification  |  CPD Challenge', size: SZ, color: '7A7A7A', font: FONT })],
      })] }),
    },
    footers: {
